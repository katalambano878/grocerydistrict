      ...
      >
        <div className="h-full px-4 py-6 overflow-y-auto">
          <Link href="/admin" className="flex items-center mb-8 px-2 cursor-pointer">
            <span className="text-xl font-bold text-[#2B2C86]">Grocery District</span>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 space-y-1">
            ...
            {userRole === 'admin' && (
              <div
                className={`flex items-center justify-between px-4 py-3 rounded-lg ${maintenanceEnabled ? 'bg-[#E6308A]/15' : 'bg-gray-50'
                  }`}
              >
                <div className="flex items-center gap-2 min-w-0">
                  <i
                    className={`text-lg shrink-0 ${maintenanceEnabled ? 'ri-tools-fill text-[#2B2C86]' : 'ri-store-2-line text-gray-600'
                      }`}
                  ></i>
                ...
                <button
                  ...
                  className={`relative flex-shrink-0 w-11 h-6 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 ${maintenanceEnabled
                    ? 'bg-[#E6308A] focus:ring-[#E6308A]/40'
