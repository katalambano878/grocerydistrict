...
export default function WishlistPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <PageHero
        title="My Wishlist"
        subtitle="Save your favourite groceries, baby care, household and skincare items for later."
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="bg-[#2B2C86] rounded-2xl p-12 text-center text-white">
