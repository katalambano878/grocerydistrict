...
export default function ShippingPage() {
  const deliveryOptions = [
    {
      ...
      cost: 'From GH₵25',
      description: 'Reliable delivery across Accra and Greater Accra',
      icon: 'ri-truck-line'
    },
    {
    ...
    },
    {
      ...
      time: 'Same Day',
      cost: 'FREE',
      description: 'Collect from our Ashongman Estate store',
  ...
  const zones = [
    {
      zone: 'Zone 1 - Central Accra',
      areas: 'Osu, Cantonments, Airport, East Legon, Labone, Dzorwulu, Ridge',
      standard: 'Same day - 1 day',
      express: 'Same day'
    },
    {
      zone: 'Zone 2 - Greater Accra',
      areas: 'Tema, Madina, Adenta, Kasoa, Achimota, Spintex, Ashongman Estate',
      standard: '1-2 days',
      express: 'Same day / next day'
    },
    {
      zone: 'Zone 3 - Major Cities',
      areas: 'Kumasi, Takoradi, Cape Coast, Tamale, Sunyani, Ho',
      standard: '2-4 days',
      express: '1-2 days'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHero
        ...
        subtitle="Fast, reliable delivery across Accra and Ghana. Pick up in-store at Ashongman Estate."
        image={HERO_IMAGES.household}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {deliveryOptions.map((option, index) => (
              <div key={index} className="bg-white border-2 border-gray-200 p-8 rounded-2xl hover:border-[#2B2C86] hover:shadow-lg transition-all">
                <div className="w-14 h-14 bg-[#F5F4FA] rounded-full flex items-center justify-center mb-6">
                  <i className={`${option.icon} text-2xl text-[#2B2C86]`}></i>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">{option.type}</h3>
                <div className="text-[#2B2C86] font-bold text-xl mb-2">{option.cost}</div>
        ...
        <div className="bg-gray-100 border-2 border-gray-200 rounded-2xl p-8 mb-16 text-center">
          <div className="w-16 h-16 bg-[#2B2C86] rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-lg text-gray-600">
            Spend GH₵300 or more and get <span className="font-bold text-[#2B2C86]">FREE standard delivery</span> anywhere in Ghana
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#E6308A]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-checkbox-circle-line text-2xl text-[#E6308A]"></i>
              </div>
              <p className="font-medium text-gray-900">Order Confirmed</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#FCE7F3] rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-package-line text-2xl text-[#2B2C86]"></i>
              </div>
              <p className="font-medium text-gray-900">Processing</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#E6308A]/10 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-truck-line text-2xl text-[#E6308A]"></i>
              </div>
          ...
          <div className="mt-8 text-center">
            <Link
              href="/order-tracking"
              className="inline-flex items-center gap-2 bg-[#2B2C86] text-white px-8 py-4 rounded-full font-medium hover:bg-[#222370] transition-colors whitespace-nowrap"
            >
