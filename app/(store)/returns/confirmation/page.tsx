      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center py-12">
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <div className="mb-8 p-6 bg-[#E6308A]/5 border border-[#E6308A]/20 rounded-xl text-left">
              <h2 className="font-bold text-gray-900 mb-4 flex items-center">
                <i className="ri-mail-line text-2xl text-[#E6308A] mr-2"></i>
                Check Your Email
              </h2>
            ...
            <div className="space-y-3">
              <Link
                href="/account"
                className="block w-full bg-[#2B2C86] hover:bg-[#222370] text-white py-4 rounded-lg font-semibold transition-colors whitespace-nowrap"
              >
                Track Return Status
              </Link>
              <Link
          ...
          <div className="mt-8 bg-[#FCE7F3] border border-[#E6308A]/30 rounded-xl p-6">
            <div className="flex items-start space-x-3">
              <i className="ri-alert-line text-2xl text-[#2B2C86] mt-0.5"></i>
              <div>
                <p className="font-semibold text-[#2B2C86] mb-2">Important Reminders</p>
                <ul className="text-sm text-[#2B2C86] space-y-1">
