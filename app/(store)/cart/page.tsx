...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        title="Shopping Cart"
        subtitle="Review your items and checkout — delivery available across Accra and Ghana."
        ...
        {cartItems.length === 0 && savedItems.length === 0 ? (
          <section className="py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
              ...
              <Link href="/shop" className="inline-block bg-[#2B2C86] hover:bg-[#222370] text-white px-8 py-4 rounded-lg font-semibold transition-colors whitespace-nowrap">
                Continue Shopping
              </Link>
            </div>
          </section>
                            ...
                            <div className="flex items-center justify-between flex-wrap gap-4">
                              ...
                              <div className="flex items-center space-x-4">
                                <div className="flex flex-col">
                                  ...
                                  {(item.moq || 1) > 1 && (
                                    <span className="text-xs text-[#E6308A] mt-1">
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      {shipping > 0 && (
                        <p className="text-sm text-[#E6308A]">
                    ...
                    <Link
                      href="/checkout"
                      className="block w-full bg-[#2B2C86] hover:bg-[#222370] text-white py-4 rounded-lg font-semibold text-center transition-colors mt-6 mb-3 whitespace-nowrap"
                    >
                      Proceed to Checkout
                    </Link>
