            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-3">
                ...
                <Link
                  ...
                  className="block bg-[#2B2C86] hover:bg-[#222370] text-white py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                  View My Tickets
                </Link>
                <Link
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <label className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                    formData.priority === 'normal' ? 'border-[#E6308A] bg-[#E6308A]/5' : 'border-gray-300'
                  }`}>
                    <input
                      type="radio"
                      value="normal"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2B2C86] focus:border-[#2B2C86] h-32 resize-none"
              ...
              <div className="flex space-x-4 pt-6">
                ...
                <button
                  ...
                  className="flex-1 py-4 bg-[#2B2C86] hover:bg-[#222370] text-white rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                >
                  {isSubmitting ? (
                    <>
          ...
          <div className="mt-8 bg-[#E6308A]/5 border border-[#E6308A]/20 rounded-xl p-6">
            <div className="flex items-start space-x-3">
              <i className="ri-information-line text-2xl text-[#E6308A] mt-0.5"></i>
              <div>
                <p className="font-semibold text-[#2B2C86] mb-2">Before submitting a ticket</p>
                <ul className="text-sm text-[#E6308A] space-y-1">
                  <li>• Check our <Link href="/help" className="underline hover:text-[#2B2C86]">Help Center</Link> for quick answers</li>
