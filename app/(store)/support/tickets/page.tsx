...
export default function MyTicketsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'open': return 'bg-[#E6308A]/10 text-[#E6308A]';
      case 'in_progress': return 'bg-[#FCE7F3] text-[#2B2C86]';
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      ...
      case 'normal': return 'text-[#E6308A]';
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              href="/support/ticket"
              className="bg-[#2B2C86] hover:bg-[#222370] text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
            >
          ...
          {filteredTickets.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm p-12 text-center">
              ...
              <Link
                href="/support/ticket"
                className="inline-block bg-[#2B2C86] hover:bg-[#222370] text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
              >
            ...
            <div className="space-y-4">
              {filteredTickets.map((ticket) => (
                <Link
                  ...
                  className="block bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-all border-2 border-transparent hover:border-[#2B2C86]"
                >
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="w-12 h-12 flex items-center justify-center bg-[#E6308A]/10 rounded-lg mb-4">
                <i className="ri-time-line text-2xl text-[#E6308A]"></i>
              </div>
              <h3 className="font-bold text-gray-900 mb-2">Response Time</h3>
              <p className="text-2xl font-bold text-[#E6308A] mb-1">24 hours</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="w-12 h-12 flex items-center justify-center bg-[#E6308A]/10 rounded-lg mb-4">
                <i className="ri-customer-service-line text-2xl text-[#E6308A]"></i>
              </div>
              <h3 className="font-bold text-gray-900 mb-2">Support Hours</h3>
              <p className="text-2xl font-bold text-[#E6308A] mb-1">24/7</p>
