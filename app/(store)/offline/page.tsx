      ...
      <div className="max-w-md w-full text-center">
          ...
          <div className="w-32 h-32 mx-auto relative">
            ...
            <div className="absolute inset-3 rounded-full bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
              <div className="relative">
                ...
                {/* Animated dots */}
                <div className="absolute -top-1 -right-1 w-4 h-4 bg-[#E6308A] rounded-full animate-bounce" style={{ animationDelay: '0s' }} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3 mb-8">
          <button
            onClick={handleRetry}
            disabled={retrying}
            className="w-full bg-[#2B2C86] hover:bg-[#222370] disabled:bg-gray-500 text-white py-4 px-6 rounded-2xl font-semibold transition-all active:scale-[0.98] shadow-lg shadow-[#2B2C86]/20 flex items-center justify-center gap-2"
          >
            {retrying ? (
              <>
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <h3 className="font-semibold text-gray-900 text-sm mb-3 flex items-center gap-2 justify-center">
            <i className="ri-lightbulb-line text-[#E6308A]" />
