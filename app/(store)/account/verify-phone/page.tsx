        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full py-3 bg-[#2B2C86] text-white rounded-lg hover:bg-[#222370] transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed font-medium whitespace-nowrap"
            >
              {isVerifying ? (
                <>
          ...
          <div className="mt-6">
            <div className="bg-[#E6308A]/5 border border-[#E6308A]/20 rounded-lg p-3">
              <p className="text-xs text-[#2B2C86]">
