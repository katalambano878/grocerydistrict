  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'dispatched_to_rider':
        return 'bg-[#E6308A]/10 text-[#E6308A]';
      case 'shipped':
        return 'bg-[#E6308A]/10 text-[#E6308A]';
      case 'processing':
        return 'bg-[#FCE7F3] text-[#2B2C86]';
      case 'cancelled':
  ...
  if (orders.length === 0) {
    return (
      <div className="py-12 text-center bg-white rounded-lg border border-gray-200">
        ...
        <Link href="/shop" className="inline-block bg-[#2B2C86] text-white px-6 py-2 rounded-lg font-medium hover:bg-[#222370] transition-colors">
          Go to Shop
        </Link>
      </div>
    );
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 pt-4 border-t border-gray-200">
                <Link
                  ...
                  className="flex-1 sm:flex-none text-center px-4 py-2 bg-[#2B2C86] text-white rounded-lg font-semibold hover:bg-[#222370] transition-colors whitespace-nowrap"
                >
