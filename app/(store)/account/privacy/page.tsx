  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6">
        <div className="bg-[#E6308A]/5 border border-[#E6308A]/20 rounded-xl p-4">
          <div className="flex gap-3">
            <i className="ri-shield-check-line text-xl text-[#E6308A] flex-shrink-0 mt-0.5"></i>
            <div>
              <h3 className="font-semibold text-[#2B2C86] mb-1">Your Privacy Matters</h3>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              ...
              <button
                ...
                disabled={exporting}
                className="px-4 py-2 bg-[#2B2C86] text-white rounded-lg hover:bg-[#222370] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed font-medium whitespace-nowrap"
              >
                {exporting ? (
                  <>
