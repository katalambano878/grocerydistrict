                ...
                {[
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-5 py-2.5 rounded-full font-medium whitespace-nowrap transition-all border shadow-sm ${activeTab === tab.id
                      ? 'bg-[#2B2C86] text-white border-[#2B2C86] ring-2 ring-[#2B2C86]/20'
                    ...
                    <form onSubmit={handleUpdateProfile} className="space-y-6">
                      ...
                      <div className="pt-4">
                        <button
                          ...
                          className="px-8 py-3 bg-[#2B2C86] hover:bg-[#222370] text-white rounded-xl font-semibold transition-all shadow-lg shadow-[#2B2C86]/20 active:scale-95 disabled:opacity-50 disabled:shadow-none"
                        >
                    ...
                    <div className="mt-12 pt-12 border-t border-gray-100">
                      ...
                      <form onSubmit={handleChangePassword} className="space-y-5">
                        ...
                        <button
                          ...
                          className="px-8 py-3 bg-[#2B2C86] hover:bg-[#222370] text-white rounded-xl font-semibold transition-all shadow-lg shadow-[#2B2C86]/10 active:scale-95 disabled:opacity-50 disabled:shadow-none"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {securityOptions.map((option, index) => (
                        <Link
                          key={index}
                          href={option.link}
                          className="flex items-center justify-between p-5 border border-gray-200 rounded-2xl hover:border-[#2B2C86] hover:shadow-md transition-all group bg-white"
                        >
                          ...
                          <div className="flex items-center gap-3 flex-shrink-0">
                            ...
                            {option.status === 'unverified' && (
                              <span className="text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-1 bg-[#FCE7F3] text-[#2B2C86] rounded-full flex items-center gap-1">
