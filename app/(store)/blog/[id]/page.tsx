...
export default async function BlogPostPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="relative h-96 bg-[#2B2C86]">
        <img
          src={post.image}
          alt={post.title}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span className="inline-block bg-[#2B2C86] text-white px-4 py-2 rounded-full text-sm font-medium mb-4">
              {post.category}
            </span>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            {relatedPosts.map((relatedPost) => (
              ...
              >
                <div className="relative h-48">
                  ...
                  />
                  <span className="absolute top-4 left-4 bg-[#2B2C86] text-white px-3 py-1 rounded-full text-xs font-medium">
        ...
        <div className="mt-16 bg-[#2B2C86] rounded-2xl p-12 text-center text-white">
