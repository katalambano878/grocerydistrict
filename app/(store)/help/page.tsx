      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 -mt-6 relative z-10 pb-8">
          <div className="relative max-w-2xl mx-auto">
            <input
              ...
              className="w-full px-6 py-4 pl-14 rounded-xl text-gray-900 text-lg focus:outline-none focus:ring-4 focus:ring-[#2B2C86]/40"
            />
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#E6308A]/10 rounded-full mx-auto mb-4">
                <i className="ri-customer-service-2-line text-3xl text-[#E6308A]"></i>
              </div>
              ...
              <span className="text-[#E6308A] font-semibold whitespace-nowrap">Create Ticket →</span>
            </Link>
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#E6308A]/10 rounded-full mx-auto mb-4">
                <i className="ri-arrow-left-right-line text-3xl text-[#E6308A]"></i>
              </div>
              ...
              <span className="text-[#E6308A] font-semibold whitespace-nowrap">Initiate Return →</span>
            </Link>
            ...
            <Link
              ...
              className="bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-all text-center"
            >
              <div className="w-16 h-16 flex items-center justify-center bg-[#FCE7F3] rounded-full mx-auto mb-4">
                <i className="ri-map-pin-line text-3xl text-[#2B2C86]"></i>
              </div>
              ...
              <span className="text-[#2B2C86] font-semibold whitespace-nowrap">Track Now →</span>
            </Link>
          </div>
        </div>
      </main>
