    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <Link
            href="/help"
            className="inline-flex items-center text-[#2B2C86] hover:text-[#222370] font-semibold mb-6 whitespace-nowrap"
          >
            ...
            {!showFeedback ? (
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 py-3 px-6 border-2 border-[#2B2C86] text-[#2B2C86] hover:bg-[#2B2C86] hover:text-white rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                ...
                {wasHelpful ? (
                  ...
                  <>
                    <div className="w-16 h-16 flex items-center justify-center bg-[#E6308A]/10 rounded-full mx-auto mb-4">
                      <i className="ri-customer-service-line text-3xl text-[#E6308A]"></i>
                    </div>
                    <p className="text-lg font-semibold text-gray-900 mb-2">
