      ...
      {showConfetti && (
        <div className="fixed inset-0 pointer-events-none z-50 overflow-hidden">
          {[...Array(50)].map((_, i) => (
            ...
            >
              <i className={`ri-${['heart', 'star', 'gift'][Math.floor(Math.random() * 3)]}-fill ${['text-gray-500', 'text-[#E6308A]', 'text-[#E6308A]'][Math.floor(Math.random() * 3)]} text-xl opacity-70`}></i>
            </div>
          ))}
        </div>
      )}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link
                ...
                className="bg-[#2B2C86] hover:bg-[#222370] text-white px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center whitespace-nowrap"
              >
            ...
            <div className="bg-[#FCE7F3] rounded-xl p-6 border-2 border-[#E6308A]/30">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 flex items-center justify-center bg-[#E6308A] rounded-full">
                ...
                <Link
                  href="/register"
                  className="bg-[#E6308A] hover:bg-[#E6308A] text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
                >
                  Join Now
                </Link>
              </div>
                  ...
                  <div key={item.id} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      {item.metadata?.preorder_shipping && (
                        <p className="text-xs text-[#2B2C86] bg-[#FCE7F3]/50 inline-flex items-center gap-1 px-2 py-0.5 rounded mt-1 border border-[#E6308A]/30">
