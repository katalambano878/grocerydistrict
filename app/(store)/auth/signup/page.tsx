    ...
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6">
        <div className="max-w-md w-full text-center">
          ...
          <Link href="/auth/login" className="inline-block bg-[#2B2C86] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#222370] transition-colors">
            Back to Login
          </Link>
        </div>
      </main>
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <Link href="/" className="inline-block mb-5">
            <img src="/logo.png" alt="Grocery District" className="h-10 mx-auto" />
          </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-[#2B2C86] focus:border-gray-600 ${errors.firstName ? 'border-[#FF6666]' : 'border-gray-300'
                    }`}
                  placeholder="John"
                />
                {errors.firstName && (
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-[#2B2C86] focus:border-gray-600 ${errors.lastName ? 'border-[#FF6666]' : 'border-gray-300'
                    }`}
                  placeholder="Doe"
                />
                {errors.lastName && (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-[#2B2C86] focus:border-gray-600 ${errors.email ? 'border-[#FF6666]' : 'border-gray-300'
                  }`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-[#2B2C86] focus:border-gray-600 ${errors.phone ? 'border-[#FF6666]' : 'border-gray-300'
                  }`}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-12 border-2 rounded-lg focus:ring-2 focus:ring-[#2B2C86] focus:border-gray-600 ${errors.password ? 'border-[#FF6666]' : 'border-gray-300'
                    }`}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-12 border-2 rounded-lg focus:ring-2 focus:ring-[#2B2C86] focus:border-gray-600 ${errors.confirmPassword ? 'border-[#FF6666]' : 'border-gray-300'
                    }`}
            ...
            <div>
              <label className="flex items-start space-x-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 mt-1 text-gray-700 rounded focus:ring-[#2B2C86]"
                />
            ...
            <button
              ...
              className="w-full bg-[#2B2C86] hover:bg-[#222370] text-white py-4 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap cursor-pointer"
            >
              {isLoading || verifying ? (
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center space-x-2 border-2 border-gray-200 bg-gray-50 py-3 rounded-lg cursor-not-allowed opacity-60"
              >
                <i className="ri-facebook-fill text-xl text-[#E6308A] grayscale opacity-50"></i>
