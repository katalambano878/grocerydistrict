      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-xl shadow-sm p-8 text-center">
            ...
            <Link
              href="/auth/login"
              className="inline-block bg-[#2B2C86] hover:bg-[#222370] text-white px-8 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
            >
              Back to Sign In
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-2 focus:ring-[#2B2C86] focus:border-gray-600 ${
            ...
            <button
              ...
              className="w-full bg-[#2B2C86] hover:bg-[#222370] text-white py-4 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
