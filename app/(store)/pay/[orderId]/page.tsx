    ...
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <Link
            href="/"
            className="inline-flex items-center px-6 py-3 bg-[#2B2C86] hover:bg-[#222370] text-white rounded-lg font-semibold transition-colors"
          >
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block mb-6">
            <span className="text-2xl font-bold text-[#2B2C86]">Grocery District</span>
          </Link>
        ...
        {!hasStockIssue && order?.payment_status === 'pending' && (
          <div className="bg-[#FCE7F3] border border-[#E6308A]/30 rounded-lg p-4 mb-6">
            <div className="flex items-start space-x-3">
              <i className="ri-time-line text-xl text-[#2B2C86] mt-0.5"></i>
              <div>
                <p className="text-sm font-semibold text-[#2B2C86]">Payment Pending</p>
                <p className="text-sm text-[#2B2C86] mt-1">Complete your payment to confirm your order.</p>
              </div>
            </div>
          </div>
        )}
        ...
        {!hasStockIssue ? (
          <button
            ...
            disabled={processing}
            className="w-full bg-[#2B2C86] hover:bg-[#222370] text-white py-4 rounded-xl font-semibold text-lg transition-colors disabled:opacity-70 flex items-center justify-center cursor-pointer"
          >
            {processing ? (
              <>
              ...
              <>
                ...
                Pay GH₵ {money(order?.total)} Securely
              </>
            )}
          </button>
        ) : (
          <div className="space-y-3">
            <Link
              href="/shop"
              className="w-full bg-[#2B2C86] hover:bg-[#222370] text-white py-4 rounded-xl font-semibold text-lg transition-colors flex items-center justify-center"
            >
