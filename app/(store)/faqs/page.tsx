...
export default function FAQsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can request changes within 1 hour of placing your order. Contact support immediately at 000 000 0000 or hello@grocerydistrict.shop. Once processing starts, changes may be limited."
    },
    {
      category: 'orders',
    ...
    },
    {
      ...
      answer: 'Delivery times depend on your location. We deliver from Ashongman Estate, Accra across Accra and nationwide in Ghana. Final delivery timelines are shown at checkout and in your order updates.'
    },
    {
      category: 'shipping',
    ...
    },
    {
      ...
      answer: 'Yes. Grocery District delivers nationwide across Ghana, in addition to same-day options within Accra. In-store pickup at Ashongman Estate is also available.'
    },
    {
      category: 'shipping',
    ...
    },
    {
      ...
      answer: 'Delivery speed depends on your location. We dispatch from Ashongman Estate, Accra and share estimated timing during checkout and after order confirmation.'
    },
    {
      category: 'returns',
    ...
    },
    {
      ...
      answer: 'We accept bank transfers, Visa/Mastercard credit and debit cards, mobile money, and Cash on Delivery for eligible orders within Accra. All payments are processed securely in Ghana Cedis (GHS).'
    },
    {
      category: 'payment',
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-3xl mx-auto -mt-6 relative z-10 mb-10">
          <div className="relative">
            <input
              ...
              className="w-full pl-12 pr-4 py-4 border border-gray-300 rounded-full focus:ring-2 focus:ring-[#2B2C86] focus:border-transparent text-sm shadow-lg"
            />
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-full font-medium transition-all whitespace-nowrap ${
                activeCategory === category.id
                  ? 'bg-[#2B2C86] text-white shadow-lg'
      ...
      <div className="bg-gradient-to-br from-[#2B2C86] to-[#1A1B5E] py-16">
