...
export default function ContactPage() {
  ...
  const contactEmail = getSetting("contact_email") || "hello@grocerydistrict.shop";
  const contactPhone = getSetting("contact_phone") || "+233 55 297 1577";
  const contactAddress = getSetting("contact_address") || "Ashongman Estate, Accra, Ghana";
  ...
  const contactMethods = [
    {
      ...
      description: "Mon–Sat, 8:30am–8pm",
    },
    {
      icon: 'ri-mail-line',
      title: 'Email Us',
    ...
    },
    {
      ...
      link: 'https://maps.google.com/?q=Ashongman+Estate+Accra',
  ...
  const faqs = [
    {
      ...
      answer: "We offer delivery across Accra and nationwide in Ghana. Delivery timelines depend on your location and are confirmed at checkout.",
    },
    {
      question: 'Do you sell wholesale and retail?',
      answer: "Yes. Grocery District serves both wholesale and retail customers — from single items to bulk orders of UK & USA groceries, baby essentials, household products and skincare.",
    },
    {
      question: 'What payment methods do you accept?',
      answer: "We accept secure payment options at checkout, including mobile money, bank transfers and card payments.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-10">
              ...
              <div className="bg-white border border-brand-carton/15 rounded-2xl p-6 sm:p-8">
                ...
                <form id="contactForm" onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full bg-[#2B2C86] text-white py-3.5 rounded-xl font-semibold text-sm hover:bg-brand-carton transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                  >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* WhatsApp CTA */}
              <div className="relative overflow-hidden rounded-2xl bg-[#E6308A] p-6 text-white">
                ...
                <div className="relative">
                  ...
                  <p className="text-sm text-white/75 mb-5 leading-relaxed">
                    Our team is available {businessHours.toLowerCase()}. For urgent matters, chat with us on WhatsApp.
                  </p>
                  <a
                    href={`https://wa.me/${phoneDigits}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-white text-[#2B2C86] px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-[#F3F3F3] transition-colors"
                  >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1 leading-relaxed">
                      Stop by our shop in Accra to browse groceries, baby care, household essentials and skincare in person.
                    </p>
