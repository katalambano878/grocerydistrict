// Grocery District — network-first pages; no HTML shell cache (playbook §16)
const CACHE_VERSION = 'sw-v2.5-grocery';
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Grocery District', options)
  );
});
