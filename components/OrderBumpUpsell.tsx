  ...
  return (
    <div className="bg-[#FCE7F3] rounded-xl p-6 border-2 border-[#E6308A]/30">
      <div className="flex items-center space-x-2 mb-4">
        <div className="w-10 h-10 flex items-center justify-center bg-[#E6308A] rounded-full">
          ...
          >
            <div className="flex items-center space-x-4">
              <input
                ...
                className="w-5 h-5 text-gray-900 rounded border-gray-300 focus:ring-[#2B2C86]"
              />
      ...
      <div className="mt-4 p-3 bg-[#FCE7F3] rounded-lg">
        <p className="text-sm text-[#2B2C86] font-medium text-center">
