  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20">
        <div 
          className="fixed inset-0 bg-[#2B2C86] bg-opacity-75 transition-opacity"
          onClick={onClose}
        ></div>
        ...
        <div className="relative bg-white rounded-lg w-full max-w-4xl">
          ...
          <div className="p-6">
            <div className="bg-[#F3F3F3] border border-[#E6308A]/30 rounded-lg p-4 mb-6">
              <div className="flex items-start">
                <div className="w-6 h-6 flex items-center justify-center mr-3">
                  <i className="ri-information-line text-xl text-[#E6308A]"></i>
                </div>
                <div>
                  <h3 className="font-semibold text-[#2B2C86] mb-2">How to Measure</h3>
            ...
            <div className="mt-6 text-center">
              ...
              <button className="px-6 py-3 bg-[#2B2C86] text-white rounded-lg font-semibold hover:bg-[#222370] transition-colors whitespace-nowrap">
                Contact Support
              </button>
            </div>
          </div>
