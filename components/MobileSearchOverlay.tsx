...
export default function MobileSearchOverlay({ isOpen, onClose }: MobileSearchOverlayProps) {
  ...
  const searchSuggestions = [
    { name: 'Summer Floral Dress', category: 'Women\'s Clothing', price: 'GH₵289', image: 'https://via.placeholder.com/400?text=Product' },
    { name: 'Classic Leather Handbag', category: 'Bags', price: 'GH₵459', image: 'https://via.placeholder.com/400?text=Product' },
    { name: 'Designer Sunglasses', category: 'Accessories', price: 'GH₵199', image: 'https://via.placeholder.com/400?text=Product' }
  ];
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full pl-10 pr-10 py-3 bg-gray-100 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-[#2B2C86]"
              autoFocus
            />
