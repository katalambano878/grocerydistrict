        ...
        {cart.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
            ...
            <Link
              href="/shop"
              onClick={onClose}
              className="px-6 py-3 bg-[#2B2C86] text-white rounded-lg font-semibold hover:bg-[#222370] transition-colors whitespace-nowrap cursor-pointer"
            >
              Continue Shopping
            </Link>
          </div>
                  ...
                  <div key={`${item.id}-${item.variant}`} className="flex space-x-4 bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.quantity >= item.maxStock && (
                        <p className="text-xs text-[#E6308A] mt-1">Max stock reached</p>
                      )}
                    </div>
            ...
            <div className="border-t border-gray-200 p-6 bg-gray-50">
              ...
              <div className="space-y-3">
                <Link
                  href="/checkout"
                  onClick={onClose}
                  className="block w-full py-4 bg-[#2B2C86] text-white text-center rounded-lg font-semibold hover:bg-[#222370] transition-colors whitespace-nowrap cursor-pointer"
                >
                  Proceed to Checkout
                </Link>
                <Link
                  href="/cart"
                  onClick={onClose}
                  className="block w-full py-4 border-2 border-[#2B2C86] text-[#2B2C86] text-center rounded-lg font-semibold hover:bg-gray-50 transition-colors whitespace-nowrap cursor-pointer"
                >
                  View Cart
                </Link>
              </div>
