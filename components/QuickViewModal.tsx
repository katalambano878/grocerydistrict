  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div 
          className="fixed inset-0 transition-opacity bg-[#2B2C86] bg-opacity-75"
          onClick={onClose}
        ></div>
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-baseline space-x-3 mb-4">
                  ...
                  {product.originalPrice && (
                    <>
                      <span className="text-lg text-gray-400 line-through"><Price amount={product.originalPrice} /></span>
                      ...
                      {product.colors.map((color) => (
                        <button
                          ...
                          className={`px-4 py-2 border-2 rounded-lg font-medium transition-colors whitespace-nowrap ${
                            selectedColor === color
                              ? 'border-[#2B2C86] bg-gray-100 text-gray-900'
                ...
                <div className="space-y-3 mt-auto">
                  <button
                    ...
                    className={`w-full py-4 rounded-lg font-semibold transition-colors whitespace-nowrap ${
                      addedToCart
                        ...
                        : product.inStock
                        ? 'bg-[#2B2C86] hover:bg-[#222370] text-white'
                  ...
                  <Link
                    ...
                    className="block w-full py-4 border-2 border-[#2B2C86] text-[#2B2C86] rounded-lg font-semibold text-center hover:bg-gray-50 transition-colors whitespace-nowrap"
                  >
                    View Full Details
                  </Link>
                </div>
