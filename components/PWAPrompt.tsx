            ...
            {isIOSDevice ? (
              ...
              <>
                ...
                <div className="bg-gray-50 rounded-2xl p-5 mb-5">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className={`flex items-start gap-3 transition-opacity ${iosStep === 0 ? 'opacity-100' : 'opacity-50'}`}>
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold ${iosStep === 0 ? 'bg-[#2B2C86] text-white' : 'bg-gray-200 text-gray-500'}`}>
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">
                          ...
                          <span className="inline-flex items-center bg-white border border-gray-200 rounded px-1.5 py-0.5 mx-0.5">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#E6308A]">
                    ...
                    <div className={`flex items-start gap-3 transition-opacity ${iosStep === 1 ? 'opacity-100' : iosStep < 1 ? 'opacity-40' : 'opacity-50'}`}>
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold ${iosStep === 1 ? 'bg-[#2B2C86] text-white' : iosStep > 1 ? 'bg-gray-200 text-gray-500' : 'bg-gray-100 text-gray-400'}`}>
                    ...
                    <div className={`flex items-start gap-3 transition-opacity ${iosStep === 2 ? 'opacity-100' : 'opacity-40'}`}>
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold ${iosStep === 2 ? 'bg-[#2B2C86] text-white' : 'bg-gray-100 text-gray-400'}`}>
                        3
                      </div>
                      <div className="flex-1">
                        <p className="text-sm font-semibold text-gray-800">Tap &quot;Add&quot;</p>
                        <p className="text-xs text-gray-500 mt-0.5">
                          Confirm by tapping <span className="font-semibold text-[#E6308A]">Add</span> in the top right corner
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <button
                  ...
                  className="w-full bg-[#2B2C86] hover:bg-[#222370] text-white py-4 px-6 rounded-2xl font-semibold text-base transition-all active:scale-[0.98] shadow-lg shadow-gray-900/20 flex items-center justify-center gap-2"
                >
                  {iosStep < 2 ? (
                    <>
                      Next Step
              ...
              <>
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-gray-900 text-lg truncate">Grocery District</h3>
                    <p className="text-sm text-gray-500">grocerydistrict.shop</p>
                    <div className="flex items-center gap-1 mt-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <i key={star} className="ri-star-fill text-[#E6308A] text-xs" />
                      ))}
