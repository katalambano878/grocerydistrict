      ...
      {!appliedCoupon ? (
        <>
          <div>
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2B2C86] focus:border-[#2B2C86] text-sm"
              />
              <button
                onClick={handleApply}
          ...
          <button
            ...
            className="text-sm text-[#2B2C86] hover:text-[#222370] font-medium flex items-center whitespace-nowrap"
          >
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {isEligible && (
                        <button
                          ...
                          className="text-[#2B2C86] hover:text-[#222370] font-semibold text-sm whitespace-nowrap"
                        >
                          Apply
                        </button>
                      )}
