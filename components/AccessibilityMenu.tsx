  ...
  return (
    <>
      <button
        ...
        className="fixed left-0 top-1/2 -translate-y-1/2 bg-[#2B2C86] hover:bg-[#222370] text-white p-3 rounded-r-lg shadow-lg z-[9997] transition-all"
                    ...
                    <button
                      ...
                      className={`py-2 px-4 rounded-lg border-2 font-medium transition-colors whitespace-nowrap ${
                        settings.fontSize === size
                          ? 'border-[#2B2C86] bg-gray-50 text-gray-900'
              ...
              <div className="pt-4 border-t border-gray-200 space-y-3">
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                      settings.readableFont ? 'bg-[#2B2C86]' : 'bg-gray-300'
                    }`}
                  >
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                      settings.hideImages ? 'bg-[#2B2C86]' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full flex items-center px-1 transition-colors ${
                      settings.highlightLinks ? 'bg-[#2B2C86]' : 'bg-gray-300'
                    }`}
                  >
                    <div className={`w-4 h-4 bg-white rounded-full shadow-sm transition-transform ${
